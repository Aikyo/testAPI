...
#pragma warning restore CA2234 // Pass system uri objects instead of strings
        ...
        public static string PostResponseJson(string url, HttpContent httpContent)
        {

            var client = new HttpClient();
            client.BaseAddress = new Uri(url);
            client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            //string Token = JsonConvert.DeserializeObject<UserInfo>(HttpContext.Current.User.Identity.Name).Token;
...
#pragma warning restore CA2234 // Pass system uri objects instead of strings
        ...
        /// </summary>
        /// <param name="url">请求地址</param>
        /// <param name="newobj">请求数据</param>
        /// <returns>字符</returns>
        public static string PostResponse(string url, object newobj)
        {
            HttpClient httpClient = new HttpClient(new HttpClientHandler() { AutomaticDecompression = DecompressionMethods.GZip });
            HttpResponseMessage response = null;
            try
            {
                ...
                httpClient.CancelPendingRequests();
                httpClient.DefaultRequestHeaders.Clear();
                string postData = JsonConvert.SerializeObject(newobj);
                HttpContent httpContent = new StringContent(postData);
                httpContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
#pragma warning disable CA2234 // Pass system uri objects instead of strings
                Task<HttpResponseMessage> taskResponse = httpClient.PostAsync(url, httpContent);
#pragma warning restore CA2234 // Pass system uri objects instead of strings
        ...
        public static string PostResponse(string url, X509Certificate2 cert, string postData)
        {
            ...
            try
            {
                ...
                HttpContent httpContent = new StringContent(postData);
                httpContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var dd = httpContent.Headers.ContentEncoding.GetType();
#pragma warning disable CA2234 // Pass system uri objects instead of strings
                Task<HttpResponseMessage> taskResponse = httpClient.PostAsync(url, httpContent);
#pragma warning restore CA2234 // Pass system uri objects instead of strings
                taskResponse.Wait();
            ...
            {
                //LogHelper.Error("结果：异常 内容：" + JsonConvertTool.SerializeObject(obj) + "ex:" + exception.Message, exception);
                return exception.Message + "PostResponse";
            }
            finally
            {
                if (response != null)
...
#pragma warning restore CA2234 // Pass system uri objects instead of strings
        ...
        /// <param name="newobj">请求数据</param>
        /// <returns>实体</returns>
        public static T PostResponse<T>(string url, object newobj)
        {
            HttpClient httpClient = new HttpClient(new HttpClientHandler() { AutomaticDecompression = DecompressionMethods.GZip });
            HttpResponseMessage response = null;
            try
...
#pragma warning restore CA2234 // Pass system uri objects instead of strings
        ...
        /// <param name="newobj">请求数据</param>
        /// <returns>字符</returns>
        public static string PutResponse(string url, object newobj)
        {
            HttpClient httpClient = new HttpClient(new HttpClientHandler() { AutomaticDecompression = DecompressionMethods.GZip });
            HttpResponseMessage response = null;
            try
...
#pragma warning restore CA2234 // Pass system uri objects instead of strings
        ...
        public static string GetResponse(Uri url, out string httpStatusCode)
        {
            throw new NotImplementedException();
        }

        public static string GetResponse(Uri url)
        {
            throw new NotImplementedException();
        }

        public static string PostResponseJson(Uri url, HttpContent httpContent)
        {
            throw new NotImplementedException();
        }

        public static string PostResponse(Uri url, string postData)
        {
            throw new NotImplementedException();
        }

        public static string PostResponse(Uri url, object newobj)
        {
            throw new NotImplementedException();
        }

        public static string PostResponse(Uri url, X509Certificate2 cert, string postData)
        {
            throw new NotImplementedException();
        }

        public static string PutResponse(Uri url, object newobj)
        {
            throw new NotImplementedException();
        }
    }
